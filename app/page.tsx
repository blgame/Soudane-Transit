  ...
  return (
    <main className="overflow-hidden bg-brand-gray text-slate-950 transition dark:bg-[#07140f] dark:text-white">
      ...
      <section className="relative overflow-hidden bg-brand-dark py-20 text-white sm:py-24">
        <Image
          src={terminalImage}
          alt="Terminal logistique avec conteneurs et camions"
          fill
          sizes="100vw"
        ...
        <div className="container-shell relative z-10">
          <div className="grid gap-10 lg:grid-cols-[0.85fr_1.15fr]">
            <div>
              <p className="section-eyebrow">Dashboard admin</p>
              <h2 className="mt-3 max-w-2xl text-3xl font-black tracking-normal sm:text-4xl">
                Une vision opérationnelle prête pour l'espace client futur.
              </h2>
              <p className="mt-4 max-w-xl leading-8 text-white/70">
                Le site prépare l'évolution vers un portail client avec dossiers,
                suivi, documents et notifications.
              </p>
              <div className="mt-7 inline-flex items-center gap-2 rounded-full border border-white/20 px-4 py-2 text-sm font-bold text-brand-light">
            ...
            <div className="grid gap-4">
              <div className="grid gap-4 sm:grid-cols-3">
                {[
                  ["Dossiers actifs", "58"],
                  ["Documents reçus", "214"],
                  ["Alertes transport", "07"]
                ].map(([label, value]) => (
                  <div key={label} className="rounded-lg bg-white/10 p-5 backdrop-blur">
              ...
              <div className="overflow-hidden rounded-lg border border-white/10 bg-white/10 backdrop-blur">
                <div className="grid grid-cols-4 border-b border-white/10 px-4 py-3 text-xs font-black uppercase tracking-[0.18em] text-white/50">
                  <span>Dossier</span>
                  <span>Client</span>
                  <span>Service</span>
                  <span>Statut</span>
                ...
                {[
                  ["ST-2048", "Teranga Foods", "Maritime", "En douane"],
                  ["ST-2051", "Dak Impex", "Transport", "Planifié"],
                  ["ST-2057", "Sahel Trade", "Aérien", "Livré"]
                ].map((row) => (
                  <div
                    key={row[0]}
                    className="grid grid-cols-4 items-center border-b border-white/10 px-4 py-4 text-sm last:border-0"
                  >
                    {row.map((cell, index) => (
                      <span
                        key={cell}
